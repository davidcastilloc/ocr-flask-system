...
class RecipeProcessor:
    ...
    def process_recipe(self, route_uploaded_img_recipe="./app/static/img/text.png"):
        raw_text = self._extract_raw_text_from_recipe("./app/static/uploads/" + route_uploaded_img_recipe)
